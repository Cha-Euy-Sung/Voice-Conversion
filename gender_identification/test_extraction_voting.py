...
standard_scalar=load('./gender_identification/Models/std_scaler.bin') #Load the standard scalar that was fitted on the training-set
...
def model_preds_nn(modelML, dataPath, filename, path_praat_file):
    """
